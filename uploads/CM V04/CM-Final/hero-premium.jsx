  ...
  return (
    <div data-screen-label="Hero · Studio (trust first)" style={{ width: PW, position: 'relative', overflow: 'hidden', fontFamily: F.sans,
      ...
      <div style={{ position: 'relative', zIndex: 2 }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', padding: "9px 64px 0px" }}>
          <PStatBar />
        </div>
        <div style={{ maxWidth: 880, margin: '40px auto 0', padding: '0 64px 220px' }}>
          <VideoGlass big reflection poster={poster} cinematic={cinematic} showTag={!cinematic} playPos={playPos} playReveal={playReveal} />
        </div>
      </div>
    </div>);
